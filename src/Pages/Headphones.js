            ...
            <Row>
              <Col lg={3}>
                <Card className="Card_products">
                  ...
                  <Card.Body>
                    <h4>REDMI 5A Earbuds, ANC ,upto 30 hrs of Battery life with...</h4>
                    <p>₹ 1,199 <button className="card-btn">Add Card</button></p>
              ...
              <Col lg={3}>
                <Card className="Card_products">
                  ...
                  <Card.Body>
                    <h4>boAt Rockerz 450 Pro with Upto 70 Hours Playback Blueto...</h4>
                    <p>₹ 1,999 <button className="card-btn">Add Card</button></p>
                    <button className="rating-btn">4.2<i class="bi bi-star"></i></button>
                  </Card.Body>
                </Card>
              </Col>
              <Col lg={3}>
                <Card className="Card_products">
                  ...
                  <Card.Body>
                    <h4>OnePlus Bullets Wireless Z2 ANC Earphones with 45dB Hyb...</h4>
                    <p>₹ 2,299 <button className="card-btn">Add Card</button></p>
                    <button className="rating-btn">4.2<i class="bi bi-star"></i></button>
                  </Card.Body>
                </Card>
              </Col>
              <Col lg={3}>
                <Card className="Card_products">
                  ...
                  <Card.Body>
                    <h4>Brolan Blue Wireless Ear Buds witth multiple features B...</h4>
                    <p>₹ 629 <button className="card-btn">Add Card</button></p>
                    <button className="rating-btn">3.4<i class="bi bi-star"></i></button>
                  </Card.Body>
                </Card>
              </Col>
            </Row>
            ...
            <Row className="phonerow">
              <Col lg={3}>
                <Card className="Card_products">
                  ...
                  <Card.Body>
                    <h4>boAt Rockerz 450 w/ 40mm Drivers, 15 HRS Playback, Soft...</h4>
              ...
              <Col lg={3}>
                <Card className="Card_products">
                  ...
                  <Card.Body>
                    <h4>Boult W20 with Zen ENC Mic, 35H Battery Life, Low Laten...</h4>
                    <p>₹ 999 <button className="card-btn">Add Card</button></p>
              ...
              <Col lg={3}>
                <Card className="Card_products">
                  ...
                  <Card.Body>
                    <h4>Apple AirPods Pro (2nd generation) with MagSafe Case (U...)</h4>
                    <p>₹ 18,999 <button className="card-btn">Add Card</button></p>
              ...
              <Col lg={3}>
                <Card className="Card_products">
                  ...
                  <Card.Body>
                    ...
                    <p>₹ 59,900 <button className="card-btn">Add Card</button></p>
            ...
            <Row className="phonerow">
              <Col lg={3}>
                <Card className="Card_products">
                  ...
                  <Card.Body>
                    ...
                    <p>₹ 19,499 <button className="card-btn">Add Card</button></p>
              ...
              <Col lg={3}>
                <Card className="Card_products">
                  ...
                  <Card.Body>
                    <h4>vivo TWS 3e buds up-to 30dB Active Noise Cancellation |...</h4>
                    <p>₹ 18,999 <button className="card-btn">Add Card</button></p>
                    <button className="rating-btn">4.1<i class="bi bi-star"></i></button>
                  </Card.Body>
                </Card>
              ...
              <Col lg={3}>
                <Card className="Card_products">
                  ...
                  <Card.Body>
                    <h4>Portronics Harmonics Z7 with 40Hrs Playback, Gaming Mod...</h4>
                    <p>₹ 571 <button className="card-btn">Add Card</button></p>
                    <button className="rating-btn">4.1<i class="bi bi-star"></i></button>
                  </Card.Body>
                </Card>
              </Col>
              <Col lg={3}>
                <Card className="Card_products">
                  ...
                  <Card.Body>
                    <h4>Boult Y1 Pro with Zen Quad Mic ENC, 60Hrs Battery, Fast...</h4>
                    <p>₹ 1,099 <button className="card-btn">Add Card</button></p>
                    <button className="rating-btn">4.1<i class="bi bi-star"></i></button>
                  </Card.Body>
                </Card>
              </Col>
