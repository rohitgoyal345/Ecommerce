            ...
            <Row>
              <Col lg={3}>
                <Card className="Card_products">
                  ...
                  <Card.Body>
                    <h4>
                      Mi Sound Outdoor 30W,IP67, Upto 12 Hours Playback 30 W ...
                    </h4>
                    <p>
                      ₹ 3,499 <button className="card-btn">Add Card</button>
                    </p>
              ...
              <Col lg={3}>
                <Card className="Card_products">
                  ...
                  <Card.Body>
                    ...
                    <p>
                      ₹ 8,499 <button className="card-btn">Add Card</button>
                    </p>
                    <button className="rating-btn">
              ...
              <Col lg={3}>
                <Card className="Card_products">
                  ...
                  <Card.Body>
                    ...
                    <p>
                      ₹ 799 <button className="card-btn">Add Card</button>
                    </p>
                    <button className="rating-btn">
            ...
            <Row className="phonerow">
              <Col lg={3}>
                <Card className="Card_products">
                  ...
                  <Card.Body>
                    <h4>
                      JBL Charge 5 with 20Hr Playtime,IP67 Rating,7500 mAh Po...
                    </h4>
                    <p>
                      ₹ 14,999 <button className="card-btn">Add Card</button>
                    </p>
                    <button className="rating-btn">
              ...
              <Col lg={3}>
                <Card className="Card_products">
                  ...
                  <Card.Body>
                    ...
                    <p>
                      ₹ 699 <button className="card-btn">Add Card</button>
                    </p>
                    <button className="rating-btn">
              ...
              <Col lg={3}>
                <Card className="Card_products">
                  ...
                  <Card.Body>
                    <h4>
                      boAt Stone Lumos w/ LED Projection, 9HRS Playback,Heara...
                    </h4>
                    <p>
                      ₹ 4,999 <button className="card-btn">Add Card</button>
                    </p>
                    <button className="rating-btn">
                      4.1<i class="bi bi-star"></i>
                    </button>
              ...
              <Col lg={3}>
                <Card className="Card_products">
                  ...
                  <Card.Body>
                    ...
                    <p>
                      ₹ 32,990 <button className="card-btn">Add Card</button>
                    </p>
                    <button className="rating-btn">
