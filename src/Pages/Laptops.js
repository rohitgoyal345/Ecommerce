            ...
            <Row>
              <Col lg={3}>
                <Card className="Card_products">
                  ...
                  <Card.Body>
                    <h4>
                      HP Intel Core i5 12th Gen 1235U - (16 GB/512 GB
                      SSD/Windows 11 Home) 15s-fq5330TU|15-fd0111TU Thin and...
                    </h4>
                    <p>
                      ₹ 52,990 <button className="card-btn">Add Card</button>
                    </p>
              ...
              <Col lg={3}>
                <Card className="Card_products">
                  ...
                  <Card.Body>
                    <h4>
                      HP Intel Core i5 13th Gen 1334U - (16 GB/512 GB
                      SSD/Windows 11 Home) 15-fd0315TU Thin and Light Laptop
                    </h4>
                    <p>
                      ₹ 53,990 <button className="card-btn">Add Card</button>
                    </p>
                    <button className="rating-btn">
              ...
              <Col lg={3}>
                <Card className="Card_products">
                  ...
                  <Card.Body>
                    <h4>
                      DELL Intel Core i5 13th Gen 1334U - (8 GB/512 GB
                      SSD/Wi...)
                    </h4>
                    <p>
                      ₹ 47,999 <button className="card-btn">Add Card</button>
                    </p>
                    <button className="rating-btn">
              ...
              <Col lg={3}>
                <Card className="Card_products">
                  ...
                  <Card.Body>
                    <h4>
                      DELL Inspiron Intel Core i5 13th Gen 13450HX - (16 GB/512
                      GB SSD/Windows 11 Home/6 GB Graphics/NVIDIA ..)
                    </h4>
                    <p>
                      ₹ 74,890 <button className="card-btn">Add Card</button>
                    </p>
                    <button className="rating-btn">
            ...
            <Row className="phonerow">
              <Col lg={3}>
                <Card className="Card_products">
                  ...
                  <Card.Body>
                    <h4>
                      Apple MacBook Air Apple M3 - (16 GB/1 TB SSD/macOS Sonoma)
                      MXCR3HN/A
                    </h4>
                    <p>
                      ₹ 1,74,900 <button className="card-btn">Add Card</button>
                    </p>
                    <button className="rating-btn">
                      4.2<i class="bi bi-star"></i>
                    </button>
              ...
              <Col lg={3}>
                <Card className="Card_products">
                  ...
                  <Card.Body>
                    <h4>
                      SAMSUNG Galaxy Book4 Intel Core i5 13th Gen 1335U - (16
                      GB/512 GB SSD/Windows 11 Home) NP750XGJ-KG2IN ...
                    </h4>
                    <p>
                      ₹ 61,990 <button className="card-btn">Add Card</button>
                    </p>
                    <button className="rating-btn">
              ...
              <Col lg={3}>
                <Card className="Card_products">
                  ...
                  <Card.Body>
                    <h4>
                      DELL Inspiron 3520 Intel Core i3 12th Gen 1215U - (8
                      GB/512 GB SSD/Windows 11 Home) New Inspiron 15 La...
                    </h4>
                    <p>
                      ₹ 34,540 <button className="card-btn">Add Card</button>
                    </p>
                    <button className="rating-btn">
                      4.2<i class="bi bi-star"></i>
                    </button>
              ...
              <Col lg={3}>
                <Card className="Card_products">
                  ...
                  <Card.Body>
                    <h4>
                      Lenovo IdeaPad 3 Intel Core i3 12th Gen 1215U - (8 GB/512
                      GB SSD/Windows 11 Home) 15IAU7 Thin and Ligh...
                    </h4>
                    <p>
                      ₹ 29,690 <button className="card-btn">Add Card</button>
                    </p>
                    <button className="rating-btn">
            ...
            <Row className="phonerow">
              ...
              <Col lg={3}>
                <Card className="Card_products">
                  ...
                  <Card.Body>
                    <h4>
                      Apple Apple M3 - (16 GB/256 GB SSD/macOS Sequoia)
                      MC8K4HN/A
                    </h4>
                    <p>
